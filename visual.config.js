...
console.assert(!fuzzy, 'Running on OS with 0.1% test pixel diff threshold! ' +
'WARNING: Do not rely on visual regression test output, re-run them on CI!');

const thresholdPercentage = fuzzy && local ? 0.1 : 0;
...
export default /** @type {import("@web/test-runner").TestRunnerConfig} */ ({
  ...
  coverageConfig: {
    report: true,
    reportDir: 'visual-coverage',
  },
  testRunnerHtml: testFramework => `
<html>
  <head>
    <link preload rel="stylesheet" href="./fonts.css">
  </head>
  <body>
